...
db.serialize(() => {
  ...
  db.get("SELECT COUNT(*) AS count FROM clients", (err, row) => {
    ...
    const clients = [
      ["361298", "4374690101156220", "GOR", "TUTYAN"],
      ["433836", "4374690101156212", "MARIAM", "KARAPETYAN"],
      ["107177", "4374690101156238", "GAYANE", "MINASYAN"],
      ["206032", "4374690101156246",   "NAREK", "BAGHDASARYAN"],
